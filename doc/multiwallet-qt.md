...
In order to support loading of multiple wallets in bitloanscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitloanscoin.cpp.
...
Changes to bitloanscoin.cpp
----------------------
bitloanscoin.cpp is the entry point into bitloanscoin-qt, and as such, will require some minor modifications to provide hooks for
