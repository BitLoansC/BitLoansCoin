...
#   c) node1 mines 32 blocks, so now node 0 has 60001bitloanscoin, node 1 has 4250bitloanscoin, node2 has none.
#   d) node0 sends 601 bitloanscoin to node2, in two transactions (301 bitloanscoin, then 300 bitloanscoin).
