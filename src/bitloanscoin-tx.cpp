...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitLoans Core bitloanscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitloanscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitloanscoin transaction") + "\n" +
                               "  bitloanscoin-tx [options] -create [commands]   " + _("Create hex-encoded bitloanscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitloanscoin transaction
