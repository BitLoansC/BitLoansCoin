...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitLoans features */
        {"bitloanscoin", "masternode", &masternode, true, true, false},
        {"bitloanscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bitloanscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitloanscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitloanscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitloanscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bitloanscoin", "startmasternode", &startmasternode, true, true, false},
        {"bitloanscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitloanscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitloanscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitloanscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitloanscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitloanscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitloanscoin", "mnbudget", &mnbudget, true, true, false},
        {"bitloanscoin", "preparebudget", &preparebudget, true, true, false},
        {"bitloanscoin", "submitbudget", &submitbudget, true, true, false},
        {"bitloanscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitloanscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitloanscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitloanscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitloanscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitloanscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitloanscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitloanscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bitloanscoin", "mnsync", &mnsync, true, true, false},
        {"bitloanscoin", "spork", &spork, true, true, false},
        {"bitloanscoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitloanscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitloanscoind, or the -server option to bitloanscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitloanscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:40763/\n";
}
