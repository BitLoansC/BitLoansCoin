...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BLON Core"),
     ...
     * override -datadir in the bitloanscoin.conf file in the default data directory
     * (to be consistent with bitloanscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
