...
public:
    ...
    void setZBitLoansControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBLON_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBLON_clicked();
    void on_pushButtonZBitLoansControl_clicked();
