                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BLON Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitloanscoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBLON"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BLON Core"), this);
    aboutAction->setStatusTip(tr("Show information about BLON Core"));
    ...
    openAction->setStatusTip(tr("Open a BLON: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BLON Core help message to get a list with possible BLON command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BLON Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BLON Core"); // default title
