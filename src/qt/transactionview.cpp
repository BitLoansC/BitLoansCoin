                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BitLoans from zBitLoans"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBitLoans"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBitLoans));
