Contributing to BLON Core
============================

The BLON Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BLON Core project, and is not to be
confused with overall BLON Network Protocol consensus changes.

Whether a pull request is merged into BLON Core rests with the project merge
...
Patches that change BLON consensus rules are considerably more involved than
...
Where a patch set proposes to change the BLON consensus, it must have been
...
The project leader is the release manager for each BLON Core release.
